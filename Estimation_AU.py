...
if __name__ == '__main__':
    ...
    # Save the samples
    np.save(folder + 'MCMCsample_AU.npy', sample_all) # sample_all is a (K,  len(m_list), N, len(theta_true))-dimensional array
